...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.Duration4();
  });
  ...
  describe('Duration4', function() {
    it('should create an instance of Duration4', function() {
      // uncomment below and update the code to test Duration4
      //var instane = new LearnApIs.Duration4();
      //expect(instance).to.be.a(LearnApIs.Duration4);
    });
