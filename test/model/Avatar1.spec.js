...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.Avatar1();
  });
  ...
  describe('Avatar1', function() {
    it('should create an instance of Avatar1', function() {
      // uncomment below and update the code to test Avatar1
      //var instane = new LearnApIs.Avatar1();
      //expect(instance).to.be.a(LearnApIs.Avatar1);
    });
