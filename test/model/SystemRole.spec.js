...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.SystemRole();
  });
  ...
  describe('SystemRole', function() {
    it('should create an instance of SystemRole', function() {
      // uncomment below and update the code to test SystemRole
      //var instane = new LearnApIs.SystemRole();
      //expect(instance).to.be.a(LearnApIs.SystemRole);
    });
