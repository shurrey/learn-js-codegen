...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.HierarchyNodeCourse();
  });
  ...
  describe('HierarchyNodeCourse', function() {
    it('should create an instance of HierarchyNodeCourse', function() {
      // uncomment below and update the code to test HierarchyNodeCourse
      //var instane = new LearnApIs.HierarchyNodeCourse();
      //expect(instance).to.be.a(LearnApIs.HierarchyNodeCourse);
    });
