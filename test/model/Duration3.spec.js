...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.Duration3();
  });
  ...
  describe('Duration3', function() {
    it('should create an instance of Duration3', function() {
      // uncomment below and update the code to test Duration3
      //var instane = new LearnApIs.Duration3();
      //expect(instance).to.be.a(LearnApIs.Duration3);
    });
