...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.LTIPlacement();
  });
  ...
  describe('LTIPlacement', function() {
    it('should create an instance of LTIPlacement', function() {
      // uncomment below and update the code to test LTIPlacement
      //var instane = new LearnApIs.LTIPlacement();
      //expect(instance).to.be.a(LearnApIs.LTIPlacement);
    });
