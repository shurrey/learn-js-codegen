...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.CourseMessagesCounts();
  });
  ...
  describe('CourseMessagesCounts', function() {
    it('should create an instance of CourseMessagesCounts', function() {
      // uncomment below and update the code to test CourseMessagesCounts
      //var instane = new LearnApIs.CourseMessagesCounts();
      //expect(instance).to.be.a(LearnApIs.CourseMessagesCounts);
    });
