...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.CourseTask();
  });
  ...
  describe('CourseTask', function() {
    it('should create an instance of CourseTask', function() {
      // uncomment below and update the code to test CourseTask
      //var instane = new LearnApIs.CourseTask();
      //expect(instance).to.be.a(LearnApIs.CourseTask);
    });
