...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.CourseMeeting();
  });
  ...
  describe('CourseMeeting', function() {
    it('should create an instance of CourseMeeting', function() {
      // uncomment below and update the code to test CourseMeeting
      //var instane = new LearnApIs.CourseMeeting();
      //expect(instance).to.be.a(LearnApIs.CourseMeeting);
    });
