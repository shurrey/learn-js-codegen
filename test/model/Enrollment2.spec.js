...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.Enrollment2();
  });
  ...
  describe('Enrollment2', function() {
    it('should create an instance of Enrollment2', function() {
      // uncomment below and update the code to test Enrollment2
      //var instane = new LearnApIs.Enrollment2();
      //expect(instance).to.be.a(LearnApIs.Enrollment2);
    });
