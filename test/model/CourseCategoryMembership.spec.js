...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.CourseCategoryMembership();
  });
  ...
  describe('CourseCategoryMembership', function() {
    it('should create an instance of CourseCategoryMembership', function() {
      // uncomment below and update the code to test CourseCategoryMembership
      //var instane = new LearnApIs.CourseCategoryMembership();
      //expect(instance).to.be.a(LearnApIs.CourseCategoryMembership);
    });
