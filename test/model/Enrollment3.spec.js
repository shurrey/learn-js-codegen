...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.Enrollment3();
  });
  ...
  describe('Enrollment3', function() {
    it('should create an instance of Enrollment3', function() {
      // uncomment below and update the code to test Enrollment3
      //var instane = new LearnApIs.Enrollment3();
      //expect(instance).to.be.a(LearnApIs.Enrollment3);
    });
