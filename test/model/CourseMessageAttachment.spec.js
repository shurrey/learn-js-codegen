...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.CourseMessageAttachment();
  });
  ...
  describe('CourseMessageAttachment', function() {
    it('should create an instance of CourseMessageAttachment', function() {
      // uncomment below and update the code to test CourseMessageAttachment
      //var instane = new LearnApIs.CourseMessageAttachment();
      //expect(instance).to.be.a(LearnApIs.CourseMessageAttachment);
    });
