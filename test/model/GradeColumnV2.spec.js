...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LearnApIs.GradeColumnV2();
  });
  ...
  describe('GradeColumnV2', function() {
    it('should create an instance of GradeColumnV2', function() {
      // uncomment below and update the code to test GradeColumnV2
      //var instane = new LearnApIs.GradeColumnV2();
      //expect(instance).to.be.a(LearnApIs.GradeColumnV2);
    });
    ...
    it('should have the property scoreProviderHandle (base name: "scoreProviderHandle")', function() {
      // uncomment below and update the code to test the property scoreProviderHandle
      //var instane = new LearnApIs.GradeColumnV2();
      //expect(instance).to.be();
    });
