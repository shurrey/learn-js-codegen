...
/**
* The Grading4 model module.
* @module model/Grading4
* @version 3900.6.0
*/
export default class Grading4 {
    /**
    * Constructs a new <code>Grading4</code>.
    ...
    */
    ...
    /**
    * Constructs a <code>Grading4</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Grading4} obj Optional instance to populate.
    * @return {module:model/Grading4} The populated <code>Grading4</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Grading4();
    ...
    * @member {module:model/Grading4.ScoringModelEnum} scoringModel
    */
