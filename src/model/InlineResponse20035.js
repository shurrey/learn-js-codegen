...
export default class InlineResponse20035 {
    ...
    * @class
    * @param results {Array.<module:model/LTIPlacement>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [LTIPlacement]);
            }
    ...
    /**
    * @member {Array.<module:model/LTIPlacement>} results
    */
    'results' = undefined;
    /**
