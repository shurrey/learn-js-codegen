...
/**
* The Grading5 model module.
* @module model/Grading5
* @version 3900.6.0
*/
export default class Grading5 {
    /**
    * Constructs a new <code>Grading5</code>.
    ...
    */
    ...
    /**
    * Constructs a <code>Grading5</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Grading5} obj Optional instance to populate.
    * @return {module:model/Grading5} The populated <code>Grading5</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Grading5();
    ...
    * @member {module:model/Grading5.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @member {module:model/Grading5.ScoringModelEnum} scoringModel
    */
