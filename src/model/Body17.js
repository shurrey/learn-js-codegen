...
export default class Body17 {
    ...
    * @class
    * @param text {String} The main text content for the question. It may include plain and formatted text, and all kinds of content supported by the full text editor.
    */
