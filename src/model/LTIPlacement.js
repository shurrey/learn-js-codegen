...
/**
* The LTIPlacement model module.
* @module model/LTIPlacement
* @version 3900.6.0
*/
export default class LTIPlacement {
    /**
    * Constructs a new <code>LTIPlacement</code>.
    * @alias module:model/LTIPlacement
    * @class
    */
    ...
    /**
    * Constructs a <code>LTIPlacement</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/LTIPlacement} obj Optional instance to populate.
    * @return {module:model/LTIPlacement} The populated <code>LTIPlacement</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LTIPlacement();
    ...
    * @member {module:model/LTIPlacement.TypeEnum} type
    */
    'type' = undefined;
    /**
