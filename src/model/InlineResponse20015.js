...
import GradeNotation from './GradeNotation';
...
export default class InlineResponse20015 {
    ...
    * @class
    * @param results {Array.<module:model/GradeNotation>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [GradeNotation]);
            }
    ...
    /**
    * @member {Array.<module:model/GradeNotation>} results
    */
    'results' = undefined;
    /**
