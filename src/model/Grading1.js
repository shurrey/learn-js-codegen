...
/**
* The Grading1 model module.
* @module model/Grading1
* @version 3900.6.0
*/
export default class Grading1 {
    /**
    * Constructs a new <code>Grading1</code>.
    ...
    * @alias module:model/Grading1
    * @class
    * @param type {module:model/Grading1.TypeEnum} The type of Grading settings for this Grade Column.   | Type      | Description  | --------- | --------- | | Attempts | Indicates score and grade values are determined based on user attempts | | Calculated | Indicates score and grade values are determined by applying a calculated formula. | | Manual | Indicates score and grade values are manually entered. | 
    ...
    */
    ...
    /**
    * Constructs a <code>Grading1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Grading1} obj Optional instance to populate.
    * @return {module:model/Grading1} The populated <code>Grading1</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Grading1();
    ...
    * @member {module:model/Grading1.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @member {module:model/Grading1.ScoringModelEnum} scoringModel
    */
