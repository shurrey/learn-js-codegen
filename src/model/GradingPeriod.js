...
/**
* The GradingPeriod model module.
* @module model/GradingPeriod
* @version 3900.6.0
*/
export default class GradingPeriod {
    /**
    * Constructs a new <code>GradingPeriod</code>.
    * @alias module:model/GradingPeriod
    * @class
    */
    ...
    /**
    * Constructs a <code>GradingPeriod</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GradingPeriod} obj Optional instance to populate.
    * @return {module:model/GradingPeriod} The populated <code>GradingPeriod</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GradingPeriod();
    ...
    * @member {module:model/GradingPeriod.DateModeEnum} dateMode
    */
    'dateMode' = undefined;
    /**
