...
/**
* The Grading6 model module.
* @module model/Grading6
* @version 3900.6.0
*/
export default class Grading6 {
    /**
    * Constructs a new <code>Grading6</code>.
    ...
    */
    ...
    /**
    * Constructs a <code>Grading6</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Grading6} obj Optional instance to populate.
    * @return {module:model/Grading6} The populated <code>Grading6</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Grading6();
    ...
    * @member {module:model/Grading6.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @member {module:model/Grading6.ScoringModelEnum} scoringModel
    */
